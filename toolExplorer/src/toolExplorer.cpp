...
/************************************************************************/
bool ToolExplorer::transformFrame(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_orig, pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_trans)
{
...
/************************************************************************/
bool ToolExplorer::mergeAllPointClouds()
{
...
bool ToolExplorer::setHand(const string& handName)
{
...
bool ToolExplorer::setEye(const string& eyeName)
{
...
void ToolExplorer::mesh2cloud(const iCub::data3D::SurfaceMeshWithBoundingBox& meshB, pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud)
...
void ToolExplorer::cloud2mesh(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud, iCub::data3D::SurfaceMeshWithBoundingBox& meshB)
...
Matrix ToolExplorer::eigMat2yarpMat(const Eigen::MatrixXf eigMat)
...
/************************************************************************/
void ToolExplorer::savePointsPly(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud, const string& savename, const bool addNum)
{
    stringstream s;
    s.str("");
    if (addNum){
