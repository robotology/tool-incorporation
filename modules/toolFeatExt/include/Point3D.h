...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_Point3D
#define YARP_THRIFT_GENERATOR_STRUCT_Point3D
...
class Point3D : public yarp::os::idl::WirePortable {
public:
  // Fields
  double x;
  double y;
  ...
  // Copy constructor
  Point3D(const Point3D& __alt) : WirePortable(__alt)  {
    this->x = __alt.x;
    this->y = __alt.y;
    this->z = __alt.z;
  }
  ...
  // Assignment operator
  const Point3D& operator = (const Point3D& __alt) {
    this->x = __alt.x;
    this->y = __alt.y;
    this->z = __alt.z;
    return *this;
...
public:
  ...
  typedef yarp::os::idl::Unwrapped<Point3D > unwrapped;
  ...
  public:
    ...
    bool edit(Point3D& obj, bool dirty = true) {
